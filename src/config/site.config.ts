...
const navHrefs = ['#', '#about', '#portfolio', '#templates', '#services', '#contact']
...
const teamMeta = [
  { id: 'sara',   image: 'https://picsum.photos/seed/member-sara/400/480',   socials: { instagram: '#', twitter: '#', linkedin: '#' } },
  { id: 'daniel', image: 'https://picsum.photos/seed/member-daniel/400/480', socials: { instagram: '#', twitter: '#', linkedin: '#' } },
  { id: 'lina',   image: 'https://picsum.photos/seed/member-lina/400/480',   socials: { instagram: '#', twitter: '#', linkedin: '#' } },
  { id: 'nina',   image: 'https://picsum.photos/seed/member-nina/400/480',   socials: { instagram: '#', twitter: '#', linkedin: '#' } },
]
...
const footerMainHrefs   = ['#', '#services', '#portfolio', '#templates', '#pricing', '#about', '#contact']
...
export const siteConfig = {
  ...
  contact: {
    ...
    form: {
      fields: en.contact.form.fields.map((f, i) => ({ id: contactFieldIds[i], ...f })),
  ...
  footer: {
    ...
    mainPages: en.footer.mainPages.map((label, i) => ({ label, href: footerMainHrefs[i] })),
    legal:     en.footer.legal.map((label, i) => ({ label, href: footerLegalHrefs[i] })),
    contact:   en.footer.contact,
    socials:   en.footer.socials.map((label, i) => ({ label, href: footerSocialHrefs[i] })),
  },
}
